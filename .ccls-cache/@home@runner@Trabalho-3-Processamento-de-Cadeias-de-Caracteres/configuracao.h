...
void tipoDeErro(int erro)
{
	...
	switch(erro)
	{
		...
		case 2:
		{
			aparenciaMenuDescricao(1);
			printf("Digite o número da ação novamente!!!\n"
			       "É preciso ler um arquivo pelo menu de seleção antes\n"
...
void explicacaoPrograma(void)
{
	...
	printf("Ideia: criar um programa capaz de coletar as palavras\n"
		   "de um texto e pesquisar a frequência da palavra\n"
		   "escolhida.\n\n");
	printf("Casamento de cadeias: Será utilizado o casamento exato\n"
		   "nas pesquisas de palavras e terá auxílio de um índice.\n\n");
	
	printf("Texto: Armazena o texto inteiro do arquivo, além de\n"
		   "um vetor com o início de cada palavra.\n\n");
	
	printf("Índice: Armazena a palavra, o número de ocorrências\n"
		   "e as posições das palavras.\n\n");
	
	printf("Ordenação: Foi utilizado algoritmos para ordenar o\n"
		   "índice por número de ocorrências e por ordem\n"
		   "alfabética.\n\n");
	
	printf("Pesquisa: Foi utilizado a pesquisa sequencial\n"
		   "padrão e a pesquisa binária.\n\n");
